namespace Baxter.Vector.Machine
{
    public class Classifier : Svc
    {
        ...
        public Classifier(Problem prob, Kernel kernel, double C, double cache_size = 100, bool probability = false)
        ...
        /// <param name="cache_size">Indicates the maximum memory that the program can use </param>
        /// <param name="probability">Set this parameter to true if you want to use the PredictProbabilities function</param>
        public Classifier(string input_file_name, Kernel kernel, double C, double cache_size = 100, bool probability = false)
        ...
        public Classifier(string model_file_name)
